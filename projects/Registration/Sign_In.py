...
class Sign: 
    def __init__(self, app):
        ...
        # self.app.iconbitmap(False,ImageTk.PhotoImage(file="icon_app.ico"))
        # # C:\\Users\\group2\\Desktop\\python\\images\\icon_app.ico"
        icon = ImageTk.PhotoImage(file="icon_app.ico")
        ...
        # self.image = Image.open("../images/photo-multicultural-community-concept-collage.jpg")
...
# ________________algorithme________________________________________________
    ...
    def open_signup(self):
        SignUpPage(self.app, self.frame_2)
